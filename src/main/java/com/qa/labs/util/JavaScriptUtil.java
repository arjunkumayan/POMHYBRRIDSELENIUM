...
public class JavaScriptUtil {
	...
	public void sendKeysUsingJSArguments(WebElement element, String value) {
		JavascriptExecutor js = (JavascriptExecutor) driver;		
		js.executeScript("arguments[0].value= arguments[10]", element,value);
	}
